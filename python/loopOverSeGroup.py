...
for item in data_loaded['serviceEngineGroup']:
    os.system('ansible-playbook {0} --extra-vars \'{{"seg":{1}}}\' --extra-vars \'{{"avi_credentials":{2}}}\' --extra-vars \'{{"cloud_vmc_uuid":{3}}}\' --extra-vars \'{{"ova_path":{4}}}\' --extra-vars \'{{"vmc_vsphere_user":{5}}}\' --extra-vars \'{{"vmc_vsphere_password":{6}}}\' --extra-vars \'{{"vmc_vsphere_server":{7}}}\' --extra-vars \'{{"vmc":{8}}}\''.format(playbook, json.dumps(item), avi_credentials, cloud_vmc_uuid, ova_path, vmc_vsphere_user, vmc_vsphere_password, vmc_vsphere_server, vmc))
