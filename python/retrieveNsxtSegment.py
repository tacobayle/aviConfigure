...
path = 'nsxt/segments'
data = {"host": sys.argv[2], "credentials_uuid": sys.argv[3], "transport_zone_id": sys.argv[4]}
segmentName = sys.argv[5]
tenant = "admin"
#
# Avi class
#
...
if __name__ == '__main__':
    ...
    for item in defineClass.postObject(path, data)["resource"]["nsxt_segments"]:
        if item['name'] == segmentName:
            segment = item
